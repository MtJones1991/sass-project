...
<div class="container">
    ...
    <div class="row mt-5 pt-5 projectDiv p-5">
        <div class="col-md-4">
            ...
            <div class="pt-5">
                <h3 class="">Project Details</h3>
                <ul class="list-group list-group-flush bootstrapList">
                    <li class="list-group-item bootstrapListItem"><a href="https://github.com/MtJones1991/python-training">https://github.com/MtJones1991/python-training</a></li>
                    <li class="list-group-item bootstrapListItem">Dapibus ac facilisis in</li>
                    <li class="list-group-item bootstrapListItem">Morbi leo risus</li>
                </ul>
            </div>
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
            <a href="#">
                <img class="img-fluid shadow" src="http://placehold.it/500x300" alt="">
            </a>
        </div>
